...
'web','api',);
        registerArgumentsSet('routes', 'signup','signup.store','login',
'login.authenticate','logout','posts.create','posts.index','posts.store',
'posts.show','posts.edit','posts.update','posts.destroy','storage.local',);
        registerArgumentsSet('views', 
'layouts.app','login','posts.create','posts.index','signup',
'top','laravel-exceptions-renderer::components.badge','laravel-exceptions-renderer::components.empty-state','laravel-exceptions-renderer::components.file-with-line','laravel-exceptions-renderer::components.formatted-source',
